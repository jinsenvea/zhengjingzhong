...
<div class="contantwebdjask">
  ...
  <div :class="this.$route.query.num==1?'hotTitlweekSellingnajizhuan':'hotTitlweekSelling'">
     <div class="hotTitlweekSellingheader">
       <!--本周热卖 bgimgrushedheader-->
       <img v-if="this.$route.query.num>1" src='../../commom/img/hotsellTitle.png'/>
       <!--呐及专区-->
        <img  v-if="this.$route.query.num==1" id='najizhuan' src='../../commom/img/najizhuan.png'/>
  ...
  <div class="hotListweekSelling" :style="!rightInajizhuanquState?'background-color: #fff6f5;':' background-color: #f4faf5;'">
     <Scroll
             ref="scroll"
      :autoUpdate="true"
        ...
        <ul>
          <router-link  v-for="(item,index)  in list" :key="index"
            ...
            <li  >
                  ...
                  <p v-if="!rightInajizhuanquState"  class="rightItemRight fr"> </p>
                     <p v-if="rightInajizhuanquState"  class="rightInajizhuanqu fr"> </p>

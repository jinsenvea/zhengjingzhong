...
import {updateReceiverAddress,toEditorReceiverAddress} from 'api/editAdress'
...
//此处可以优化
          ...
          //收件人
            if(_this.receiver==''){
                 ...
                 this.$store.dispatch('toast',"收件人姓名不能为空");
                  ...
                  this.$store.dispatch('toast',"详细地址不能为空");

            }else{
              //上述可优化
                 this.receiverAddress.id=this.$route.query.id
                  ...
                  param.append("token",this.$store.state.login.token);    
                    ...
                    updateReceiverAddress(param).then((res)=>{
       ...
       _toEditorReceiverAddress(){


      

         toEditorReceiverAddress(commonParams.searxhshopsParams({id:this.$route.query.id})).then((res)=>{
           console.log(res)
           if(res.data.status==1){
                // receiver:'',//收货人
                this.receiver=res.data.data.receiver
                    this.phone=res.data.data.phone
                     this.detailAddress=res.data.data.detailAddress
                       this.provinceValue=res.data.data.pro
                         this.cityValue=res.data.data.city
                           this.areaValue=res.data.data.area
